...
interface CrawlerModelProps {
  scale?: number | [number, number, number];
  position?: [number, number, number];
  rotation?: [number, number, number];
}

export function CrawlerModel(props: CrawlerModelProps) {
  const { scene } = useGLTF('/models/Crawler.glb');
...
useGLTF.preload('/models/Crawler.glb');
